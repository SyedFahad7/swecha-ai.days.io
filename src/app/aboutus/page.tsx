  ...
  return (
    <main className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      ...
      <section className="max-w-7xl mx-auto mb-16">
        <h1 className="text-4xl font-bold text-center mb-12">About AI Days 2025</h1>
...
function TeamSection({ title, members }: TeamSectionProps) {
  return (
    <section className="max-w-7xl mx-auto mb-24 py-16">
      <h2 className="text-4xl font-bold text-center mb-16">{title}</h2>
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 justify-items-center px-4">
