            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-purple-900/20 to-yellow-900/20 border border-yellow-900/30 rounded-lg p-8">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-yellow-200 mb-2">{event.speaker.name}</h3>
                    <p className="text-yellow-100/60 mb-4">{event.speaker.role} at {event.speaker.organization}</p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-br from-cyan-900/20 to-blue-900/20 border border-cyan-900/30 rounded-lg p-6">
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-cyan-200 mb-2">{event.moderator.name}</h3>
                      <p className="text-cyan-100/60 mb-2">{event.moderator.role} at {event.moderator.organization}</p>
                    ...
                    >
                      <div className="flex items-start gap-6">
                        ...
                        <div>
                          ...
                          <p className="text-cyan-100/60 mb-2">{panelist.role} at {panelist.organization}</p>
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xl text-yellow-200">{event.details.capacity} participants</div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-br from-green-900/20 to-emerald-900/20 border border-green-900/30 rounded-lg p-6">
                  <div className="flex items-start gap-6">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-green-200 mb-2">{event.details.organizer.name}</h3>
                      <p className="text-green-100/60 mb-4">{event.details.organizer.role} at {event.details.organizer.organization}</p>
